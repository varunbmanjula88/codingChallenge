  ...
  return (
    <div className="col-md-11">
      <div className="col-md-6">
        <img
          className="character-img-left rounded"
        ...
        <div className="character-details-right">
          {props.selectedCharacter.name && (
            <div className="character-detail-field border-bottom row">
              ...
              <p className="col-sm-8">{props.selectedCharacter.name}</p>
            </div>
          )}
          ...
          {props.selectedCharacter.origin &&
            props.selectedCharacter.origin.name && (
              <div className="character-detail-field border-bottom row">
                <label className="col-sm-4">ORIGIN:</label>
          ...
          {props.selectedCharacter.episodesList &&
            props.selectedCharacter.episodesList.length > 0 && (
              <div className="character-detail-field border-bottom row">
                <label className="col-sm-4">EPISODES:</label>
                <div className="col-sm-8">
                  {props.selectedCharacter.episodesList &&
                    props.selectedCharacter.episodesList.map(
                      (episode, index) => <p key={index}>{episode.name}</p>
                    )}
                </div>
              </div>
            )}
...
export default connect(state => state, {})(CharacterInfoComponent);
